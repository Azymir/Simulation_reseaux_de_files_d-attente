      ...
      if(nbClientsInitial < 0) throw ("Méthode executer_simulation : entier nbClientsInitial négatif");
        ...
        && (!echeancier->getListeEvenement().empty()))
        {
          ...
          if(!echeancier->getListeEvenement().empty())
          {
            ...
            cout << "Type :" << echeancier->getListeEvenement().front().type_evenement << endl;
            ...
            if(echeancier->getListeEvenement().front().date_traitement > simulation.getDureeSimulation())
            {
              break;
            }

        		//Exécuter l'échéancier
            //Compter un évènement de type 3
